...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 22, fontWeight: '700', color: '#1A1A1A', fontFamily: "'Noto Sans Hebrew', sans-serif" },
  refreshIcon: { fontSize: 22, color: '#5CC8A8' },
  spin: { opacity: 0.5 },
  loadingWrap: { alignItems: 'center', justifyContent: 'center', paddingVertical: 80, gap: 16 },
  loadingText: { fontSize: 14, color: '#6B6155', fontFamily: "'Noto Sans Hebrew', sans-serif" },
  errorWrap: { alignItems: 'center', justifyContent: 'center', paddingVertical: 60, gap: 12 },
  errorIcon: { fontSize: 40, color: '#EF4444' },
  errorText: { fontSize: 14, color: '#6B6155', textAlign: 'center', fontFamily: "'Noto Sans Hebrew', sans-serif" },
  ...
  tabText: { fontSize: 13, fontWeight: '600', color: '#6B6155', fontFamily: "'Noto Sans Hebrew', sans-serif" },
  tabTextActive: { color: '#fff' },
  sectionLabel: { fontSize: 16, fontWeight: '700', color: '#1A1A1A', marginBottom: 4, fontFamily: "'Noto Sans Hebrew', sans-serif" },
  ...
  kpiValue: { fontSize: 28, fontWeight: '800', color: '#1A1A1A', fontFamily: "'Noto Sans Hebrew', sans-serif" },
  kpiLabel: { fontSize: 13, color: '#6B6155', marginTop: 4, fontFamily: "'Noto Sans Hebrew', sans-serif" },
  card: { backgroundColor: '#fff', borderRadius: 16, padding: 16, shadowColor: '#000', shadowOpacity: 0.06, shadowRadius: 8, elevation: 2 },
  emptyText: { fontSize: 14, color: '#8B8175', textAlign: 'center', paddingVertical: 24, fontFamily: "'Noto Sans Hebrew', sans-serif" },
  dailyRow: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 6 },
  dailyDate: { width: 50, fontSize: 12, color: '#6B6155', fontFamily: "'Noto Sans Hebrew', sans-serif" },
  ...
  dailyCount: { width: 30, fontSize: 13, fontWeight: '600', color: '#1A1A1A', textAlign: 'left', fontFamily: "'Noto Sans Hebrew', sans-serif" },
  tableHeader: { flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: '#E8E2D5', paddingBottom: 8, marginBottom: 4 },
  tableHeaderCell: { fontWeight: '700', color: '#1A1A1A', fontSize: 12, fontFamily: "'Noto Sans Hebrew', sans-serif" },
  ...
  tableCell: { fontSize: 12, color: '#4A4035', fontFamily: "'Noto Sans Hebrew', sans-serif" },
  ...
  activityDesc: { fontSize: 13, fontWeight: '600', color: '#1A1A1A', fontFamily: "'Noto Sans Hebrew', sans-serif" },
  activityMeta: { fontSize: 11, color: '#8B8175', marginTop: 2, fontFamily: "'Noto Sans Hebrew', sans-serif" },
  ...
  modeBtnText: { fontSize: 13, fontWeight: '600', color: '#6B6155', fontFamily: "'Noto Sans Hebrew', sans-serif" },
  modeBtnTextActive: { color: '#fff' },
  input: { backgroundColor: '#F5F0E6', borderRadius: 10, paddingVertical: 12, paddingHorizontal: 14, fontSize: 14, marginBottom: 10, borderWidth: 1, borderColor: '#E8E2D5', fontFamily: "'Noto Sans Hebrew', sans-serif", color: '#1A1A1A' },
  ...
  typeBtnText: { fontSize: 12, fontWeight: '600', color: '#6B6155', fontFamily: "'Noto Sans Hebrew', sans-serif" },
  ...
  resultText: { fontSize: 13, color: '#5CC8A8', textAlign: 'center', marginTop: 10, fontFamily: "'Noto Sans Hebrew', sans-serif" },
  ...
  drawerTitle: { fontSize: 18, fontWeight: '700', color: '#1A1A1A', fontFamily: "'Noto Sans Hebrew', sans-serif" },
  ...
  drawerEmail: { fontSize: 15, fontWeight: '600', color: '#1A1A1A', textAlign: 'center', marginBottom: 16, fontFamily: "'Noto Sans Hebrew', sans-serif" },
  ...
  subTabText: { fontSize: 12, fontWeight: '600', color: '#6B6155', fontFamily: "'Noto Sans Hebrew', sans-serif" },
  ...
  drawerStatValue: { fontSize: 20, fontWeight: '800', color: '#1A1A1A', fontFamily: "'Noto Sans Hebrew', sans-serif" },
  drawerStatLabel: { fontSize: 11, color: '#6B6155', marginTop: 2, fontFamily: "'Noto Sans Hebrew', sans-serif" },
  ...
  infoLabel: { fontSize: 13, color: '#6B6155', fontFamily: "'Noto Sans Hebrew', sans-serif" },
  infoValue: { fontSize: 13, fontWeight: '600', color: '#1A1A1A', fontFamily: "'Noto Sans Hebrew', sans-serif" },
  drawerItem: { paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: '#E8E2D5' },
  drawerItemText: { fontSize: 13, fontWeight: '600', color: '#1A1A1A', fontFamily: "'Noto Sans Hebrew', sans-serif" },
  drawerItemMeta: { fontSize: 11, color: '#8B8175', marginTop: 2, fontFamily: "'Noto Sans Hebrew', sans-serif" },
  ...
  toggleBtnText: { fontSize: 14, fontWeight: '700', color: '#1A1A1A', fontFamily: "'Noto Sans Hebrew', sans-serif" },
  ...
  gateTitle: { fontSize: 20, fontWeight: '700', color: '#1A1A1A', marginBottom: 4, fontFamily: "'Noto Sans Hebrew', sans-serif" },
  gateSub: { fontSize: 14, color: '#6B6155', marginBottom: 20, fontFamily: "'Noto Sans Hebrew', sans-serif" },
  gateInput: { width: '100%', backgroundColor: '#F5F0E6', borderRadius: 12, paddingVertical: 14, paddingHorizontal: 16, fontSize: 16, borderWidth: 1, borderColor: '#E8E2D5', marginBottom: 12, fontFamily: "'Noto Sans Hebrew', sans-serif", color: '#1A1A1A' },
