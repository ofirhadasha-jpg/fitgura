...
const evStyles = StyleSheet.create({
  ...
  summaryChipText: { fontSize: 12, fontWeight: '700', color: '#5CC8A8', fontFamily: "'Noto Sans Hebrew', sans-serif" },
  ...
  eventName: { fontWeight: '700', fontSize: 15, color: '#1A1A1A', fontFamily: "'Noto Sans Hebrew', sans-serif" },
  eventDate: { fontSize: 12, color: '#8B8175', marginTop: 3, fontFamily: "'Noto Sans Hebrew', sans-serif" },
  ...
  pastBadgeText: { fontSize: 11, color: '#8B8175', fontWeight: '600', fontFamily: "'Noto Sans Hebrew', sans-serif" },
  ...
  timelineLabel: { fontSize: 10, color: '#8B8175', fontFamily: "'Noto Sans Hebrew', sans-serif" },
  ...
  tipText: { fontSize: 12, color: '#1A1A1A', lineHeight: 19, flex: 1, fontFamily: "'Noto Sans Hebrew', sans-serif" },
  ...
  presetLabel: { fontSize: 13, fontWeight: '700', color: '#6B6155', marginBottom: 10, fontFamily: "'Noto Sans Hebrew', sans-serif" },
  ...
  dividerText: { fontSize: 11, color: '#D4C9B5', fontFamily: "'Noto Sans Hebrew', sans-serif" },
  inputLabel: { fontSize: 12, fontWeight: '700', color: '#6B6155', marginBottom: 6, fontFamily: "'Noto Sans Hebrew', sans-serif" },
  textInput: { paddingVertical: 12, paddingHorizontal: 14, borderRadius: 14, borderWidth: 1.5, borderColor: '#E8E2D5', fontSize: 14, backgroundColor: '#F5F0E6', color: '#1A1A1A', fontFamily: "'Noto Sans Hebrew', sans-serif" },
  ...
  platformNote: { fontSize: 11, color: '#6B6155', marginTop: 8, fontFamily: "'Noto Sans Hebrew', sans-serif" },
