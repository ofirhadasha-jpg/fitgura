        ...
        {sizeSorted.length === 0 && !isLoadingProducts && !productsError && (
          <View style={feedStyles.emptyState}>
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.8}
              style={{ marginTop: 12, backgroundColor: '#FFE566', borderRadius: 8, paddingVertical: 8, paddingHorizontal: 16, borderWidth: 1.5, borderColor: '#1A1A1A', boxShadow: '2px 2px 0 #1A1A1A' }}
            >
...
const feedStyles = StyleSheet.create({
  ...
  loggedInBadge: { backgroundColor: '#FFFACC', borderRadius: 8, paddingVertical: 2, paddingHorizontal: 7, borderWidth: 1, borderColor: '#FFE566' },
  loggedInBadgeText: { fontSize: 13, color: '#1A1A1A', fontWeight: '600', fontFamily: "'Caveat', 'Noto Sans Hebrew', cursive" },
  guestBadge: { backgroundColor: '#FFF0F0', borderRadius: 8, paddingVertical: 2, paddingHorizontal: 7, borderWidth: 1, borderColor: '#DC2626' },
  guestBadgeText: { fontSize: 13, color: '#DC2626', fontWeight: '600', fontFamily: "'Caveat', 'Noto Sans Hebrew', cursive" },
  avatarBtn: { width: 38, height: 38, borderRadius: 12, alignItems: 'center', justifyContent: 'center', borderWidth: 1.5, borderColor: '#1A1A1A' },
  ...
  budgetCard: { backgroundColor: '#FFFEF5', borderRadius: 12, padding: 14, borderWidth: 1.5, borderColor: '#1A1A1A', marginBottom: 12, boxShadow: '3px 3px 0 #1A1A1A' } as React.CSSProperties,
  ...
  searchBox: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#FFFACC', borderRadius: 8, paddingVertical: 10, paddingHorizontal: 14, borderWidth: 1.5, borderColor: '#1A1A1A', marginBottom: 12, boxShadow: '2px 2px 0 #1A1A1A' } as React.CSSProperties,
  searchInput: { flex: 1, fontSize: 15, color: '#1A1A1A', fontFamily: "'Caveat', 'Noto Sans Hebrew', cursive" },
  filterRow: { flexGrow: 0 },
  filterBtn: { paddingVertical: 7, paddingHorizontal: 16, borderRadius: 8, backgroundColor: '#F5F0E0', borderWidth: 1.5, borderColor: 'transparent' },
  ...
  aiMatchBar: { borderRadius: 12, padding: 14, flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: '#1A1A1A', borderWidth: 1.5, borderColor: '#1A1A1A', boxShadow: '3px 3px 0 #FFE566' } as React.CSSProperties,
  ...
  aiMatchCount: { backgroundColor: 'rgba(0,255,102,0.2)', borderRadius: 8, paddingVertical: 4, paddingHorizontal: 10, borderWidth: 1, borderColor: '#00FF66' },
  aiMatchCountText: { fontSize: 14, fontWeight: '700', color: '#00FF66', fontFamily: "'Permanent Marker', cursive" },
  loadingState: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, paddingVertical: 14, backgroundColor: '#FFFACC', borderRadius: 8, borderWidth: 1, borderColor: '#FFE566' },
  loadingText: { color: '#1A1A1A', fontSize: 14, fontWeight: '600', fontFamily: "'Caveat', 'Noto Sans Hebrew', cursive" },
  productsNotice: { padding: 16, backgroundColor: '#FFF0F0', borderRadius: 8, borderWidth: 1.5, borderColor: '#1A1A1A', gap: 8, boxShadow: '2px 2px 0 #1A1A1A' } as React.CSSProperties,
  ...
  retryBtn: { alignSelf: 'center', marginTop: 8, backgroundColor: '#DC2626', borderRadius: 8, paddingVertical: 6, paddingHorizontal: 12, borderWidth: 1.5, borderColor: '#1A1A1A' },
  ...
  familyTeaser: { backgroundColor: '#FFFACC', borderRadius: 12, padding: 14, flexDirection: 'row', alignItems: 'center', gap: 12, borderWidth: 1.5, borderColor: '#FFE566', boxShadow: '3px 3px 0 #1A1A1A' } as React.CSSProperties,
  ...
  familyBadge: { backgroundColor: '#FFFACC', borderRadius: 8, paddingVertical: 4, paddingHorizontal: 10, borderWidth: 1, borderColor: '#FFE566' },
  ...
  deviceChip: { flexDirection: 'row-reverse', alignItems: 'center', gap: 6, backgroundColor: '#FFFEF5', borderRadius: 8, paddingVertical: 6, paddingHorizontal: 12, borderWidth: 1.5, borderColor: '#9A9A9A' },
  ...
  deviceChipRemove: { width: 18, height: 18, borderRadius: 8, backgroundColor: '#FFF0F0', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#DC2626' },
  deviceChipRemoveText: { fontSize: 10, fontWeight: '700', color: '#DC2626' },
  addDeviceBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#00FF66', borderRadius: 8, paddingVertical: 7, paddingHorizontal: 13, minWidth: 112, borderWidth: 1.5, borderColor: '#1A1A1A', boxShadow: '2px 2px 0 #1A1A1A' } as React.CSSProperties,
