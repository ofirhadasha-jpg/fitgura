...
const feedStyles = StyleSheet.create({
  ...
  searchBox: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#F5F0E6', borderRadius: 16, paddingVertical: 10, paddingHorizontal: 14, borderWidth: 1.5, borderColor: '#E8E2D5', marginBottom: 12 } as React.CSSProperties,
  searchInput: { flex: 1, fontSize: 13, color: '#1A1A1A', fontFamily: "'Heebo', sans-serif" },
  filterRow: { flexGrow: 0 },
  filterBtn: { paddingVertical: 7, paddingHorizontal: 16, borderRadius: 12, backgroundColor: '#F5F0E6' } as React.CSSProperties,
