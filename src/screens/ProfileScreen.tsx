        ...
        {scannedSizes?.sizing.bodyMetrics && (
          <View style={profStyles.card}>
            <View style={profStyles.sizesHeader}>
              ...
              <Text style={{ fontSize: 11, color: '#8B8175', fontFamily: "'Heebo', sans-serif" }}>
...
const profStyles = StyleSheet.create({
  ...
  userName: { fontSize: 20, fontWeight: '700', color: '#fff', fontFamily: "'Heebo', sans-serif" },
  ...
  userStatusText: { fontSize: 12, color: 'rgba(255,255,255,0.6)', fontFamily: "'Heebo', sans-serif" },
  signOutBtn: { backgroundColor: 'rgba(255,255,255,0.15)', borderRadius: 8, paddingVertical: 4, paddingHorizontal: 10, marginLeft: 6 },
  signOutBtnText: { fontSize: 11, fontWeight: '700', color: '#fff', fontFamily: "'Heebo', sans-serif" },
  ...
  toggleTitle: { fontWeight: '700', color: '#1A1A1A', fontSize: 14, fontFamily: "'Heebo', sans-serif" },
  toggleSub: { fontSize: 11, color: '#8B8175', marginTop: 2, fontFamily: "'Heebo', sans-serif" },
  ...
  sizesTitle: { fontWeight: '700', color: '#1A1A1A', fontSize: 15, fontFamily: "'Heebo', sans-serif" },
  editBtn: { backgroundColor: '#FAF7F0', borderRadius: 8, paddingVertical: 5, paddingHorizontal: 12 },
  editBtnActive: { backgroundColor: '#1A1A1A' },
  editBtnText: { color: '#1A1A1A', fontSize: 12, fontWeight: '600', fontFamily: "'Heebo', sans-serif" },
  ...
  sizeRegionHint: { fontSize: 11, color: '#6B6155', marginTop: 10, textAlign: 'right', fontFamily: "'Heebo', sans-serif" },
  regionSub: { fontSize: 11, color: '#8B8175', marginTop: 4, marginBottom: 12, textAlign: 'right', fontFamily: "'Heebo', sans-serif" },
  ...
  regionOptionText: { fontSize: 12, fontWeight: '700', color: '#6B6155', textAlign: 'center', fontFamily: "'Heebo', sans-serif" },
  regionOptionTextActive: { color: '#1A1A1A' },
  sizeLabel: { fontSize: 11, color: '#4A4035', marginBottom: 8, textAlign: 'right', fontWeight: '700', fontFamily: "'Heebo', sans-serif" },
  ...
  devicesTitle: { fontWeight: '700', color: '#1A1A1A', fontSize: 15, fontFamily: "'Heebo', sans-serif" },
  addDeviceBtn: { backgroundColor: '#1A1A1A', borderRadius: 10, paddingVertical: 7, paddingHorizontal: 14 },
  addDeviceBtnText: { color: '#fff', fontSize: 13, fontWeight: '700', fontFamily: "'Heebo', sans-serif" },
  ...
  devicesNote: { fontSize: 11, color: '#8B8175', textAlign: 'center', marginTop: 10, fontFamily: "'Heebo', sans-serif" },
  galleryHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 12 },
  galleryTitle: { fontWeight: '700', color: '#1A1A1A', fontSize: 15, fontFamily: "'Heebo', sans-serif" },
  gallerySub: { fontSize: 11, color: '#8B8175', marginTop: 3, fontFamily: "'Heebo', sans-serif" },
  galleryLastScan: { fontSize: 10, color: '#4CAF7D', fontWeight: '700' },
  galleryNextScan: { fontSize: 10, color: '#8B8175', marginTop: 2, fontFamily: "'Heebo', sans-serif" },
  ...
  galleryAccessText: { fontSize: 10, fontWeight: '700', color: '#4CAF7D', fontFamily: "'Heebo', sans-serif" },
  ...
  galleryAccessPromptTitle: { fontSize: 13, fontWeight: '700', color: '#6B6155', fontFamily: "'Heebo', sans-serif" },
  galleryAccessPromptSub: { fontSize: 11, color: '#4A4035', marginTop: 3, lineHeight: 16, fontFamily: "'Heebo', sans-serif" },
  galleryAccessGrantBtn: { backgroundColor: '#F5D547', borderRadius: 10, paddingVertical: 8, paddingHorizontal: 16 },
  galleryAccessGrantBtnText: { color: '#fff', fontSize: 13, fontWeight: '700', fontFamily: "'Heebo', sans-serif" },
  ...
  autoScanTitle: { fontSize: 14, fontWeight: '700', color: '#1A1A1A', fontFamily: "'Heebo', sans-serif" },
  ...
  autoScanPct: { fontSize: 13, fontWeight: '700', color: '#1A1A1A', fontFamily: "'Heebo', sans-serif" },
  ...
  scanNowBtnText: { color: '#fff', fontSize: 14, fontWeight: '700', fontFamily: "'Heebo', sans-serif" },
  ...
  lastScanText: { fontSize: 12, fontWeight: '700', color: '#3A8B5E', fontFamily: "'Heebo', sans-serif" },
  lastScanSub: { fontSize: 11, color: '#4CAF7D', marginTop: 2, fontFamily: "'Heebo', sans-serif" },
  ...
  manualUploadLinkText: { fontSize: 13, fontWeight: '600', color: '#4A4035', fontFamily: "'Heebo', sans-serif" },
  galleryEmptyBox: { alignItems: 'center', gap: 10, paddingVertical: 28, paddingHorizontal: 16 },
  galleryEmptyTitle: { fontSize: 15, fontWeight: '700', color: '#1A1A1A', fontFamily: "'Heebo', sans-serif" },
  galleryEmptySub: { fontSize: 12, color: '#8B8175', textAlign: 'center', lineHeight: 18, fontFamily: "'Heebo', sans-serif" },
  ...
  galleryStatusTitle: { fontSize: 12, fontWeight: '700', color: '#3A8B5E', fontFamily: "'Heebo', sans-serif" },
  galleryStatusSub: { fontSize: 11, color: '#4CAF7D', marginTop: 2, fontFamily: "'Heebo', sans-serif" },
  ...
  scanDate: { fontSize: 13, fontWeight: '700', color: '#1A1A1A', fontFamily: "'Heebo', sans-serif" },
  ...
  scanDeleteBtnText: { fontSize: 11, fontWeight: '700', color: '#DC2626', fontFamily: "'Heebo', sans-serif" },
  galleryNote: { fontSize: 11, color: '#8B8175', textAlign: 'center', marginTop: 12, fontFamily: "'Heebo', sans-serif" },
  ...
  combinedThumbLabelTxt: { fontSize: 10, fontWeight: '700', color: '#fff', fontFamily: "'Heebo', sans-serif" },
  combinedStripSub: { fontSize: 11, color: '#6B6155', marginBottom: 12, lineHeight: 16, fontFamily: "'Heebo', sans-serif" },
  ...
  noNewText: { fontSize: 12, fontWeight: '700', color: '#4A4035', fontFamily: "'Heebo', sans-serif" },
  noNewSub: { fontSize: 11, color: '#8B8175', marginTop: 2, fontFamily: "'Heebo', sans-serif" },
  ...
  familyCTATitle: { fontSize: 14, fontWeight: '700', color: '#E84B35', fontFamily: "'Heebo', sans-serif" },
  familyCTASub: { fontSize: 12, color: '#F5D547', marginTop: 2, fontFamily: "'Heebo', sans-serif" },
  familyCTABadge: { backgroundColor: 'rgba(255,107,107,0.12)', borderRadius: 8, paddingVertical: 4, paddingHorizontal: 10 },
  familyCTABadgeText: { fontSize: 11, fontWeight: '700', color: '#E84B35', fontFamily: "'Heebo', sans-serif" },
  ...
  precisionTitle: { fontSize: 14, fontWeight: '700', color: '#1A1A1A', fontFamily: "'Heebo', sans-serif" },
  precisionSub: { fontSize: 12, color: '#4A4035', lineHeight: 18, marginTop: 4, fontFamily: "'Heebo', sans-serif" },
  ...
  precisionUploadBtnText: { color: '#fff', fontSize: 12, fontWeight: '700', fontFamily: "'Heebo', sans-serif" },
  ...
  bodyMetricInput: { flex: 1, minWidth: 34, fontSize: 16, fontWeight: '700', color: '#1A1A1A', textAlign: 'right', paddingVertical: 4, paddingHorizontal: 4, borderBottomWidth: 1, borderBottomColor: '#E8E2D5', fontFamily: "'Heebo', sans-serif" },
  bodyMetricUnit: { fontSize: 10, color: '#8B8175' },
  bodyMetricLabel: { flexShrink: 1, fontSize: 11, color: '#6B6155', fontFamily: "'Heebo', sans-serif" },
  hiddenAdminTrigger: { alignSelf: 'center', marginTop: 16, marginBottom: 8, opacity: 0.3 },
  versionLabel: { fontSize: 10, color: '#8B8175', fontFamily: "'Heebo', sans-serif" },
  ...
  photoPlaceholderText: { fontSize: 13, color: '#8B8175', fontFamily: "'Heebo', sans-serif" },
  ...
  photoBtnPrimaryText: { color: '#fff', fontSize: 13, fontWeight: '700', fontFamily: "'Heebo', sans-serif" },
  photoBtnDangerText: { color: '#DC2626', fontSize: 13, fontWeight: '700', fontFamily: "'Heebo', sans-serif" },
  photoLoginHint: { fontSize: 11, color: '#8B8175', textAlign: 'center', marginTop: 8, fontFamily: "'Heebo', sans-serif" },
  photoErrorBox: { backgroundColor: '#FEF2F2', borderRadius: 10, padding: 10, marginTop: 10, borderWidth: 1.5, borderColor: '#FECACA' },
  photoErrorText: { fontSize: 12, color: '#DC2626', fontWeight: '600', fontFamily: "'Heebo', sans-serif" },
  ...
  photoToastText: { color: '#fff', fontSize: 14, fontWeight: '700', fontFamily: "'Heebo', sans-serif" },
  confirmSheet: { backgroundColor: '#fff', borderTopLeftRadius: 32, borderTopRightRadius: 32, padding: 28, gap: 16 },
  confirmTitle: { fontSize: 18, fontWeight: '800', color: '#1A1A1A', fontFamily: "'Heebo', sans-serif" },
  confirmDesc: { fontSize: 14, color: '#6B6155', lineHeight: 20, fontFamily: "'Heebo', sans-serif" },
  ...
  confirmCancelBtnText: { color: '#4A4035', fontSize: 14, fontWeight: '700', fontFamily: "'Heebo', sans-serif" },
  confirmDeleteBtn: { flex: 1, padding: 14, borderRadius: 14, backgroundColor: '#DC2626', alignItems: 'center' },
  confirmDeleteBtnText: { color: '#fff', fontSize: 14, fontWeight: '700', fontFamily: "'Heebo', sans-serif" },
})
