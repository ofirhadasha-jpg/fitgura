...
const modalStyles = StyleSheet.create({
  ...
  sheet: { backgroundColor: '#FFFEF5', backgroundImage: 'repeating-linear-gradient(0deg, transparent, transparent 27px, rgba(0,0,0,0.04) 27px, rgba(0,0,0,0.04) 28px)', borderRadius: 12, padding: 28, maxHeight: '80%', width: '92%', maxWidth: 420, borderWidth: 1.5, borderColor: '#1A1A1A', boxShadow: '3px 3px 0 #1A1A1A' } as React.CSSProperties,
  ...
  sheetCloseBtn: { width: 32, height: 32, borderRadius: 8, backgroundColor: '#F5F0E0', alignItems: 'center', justifyContent: 'center', borderWidth: 1.5, borderColor: '#1A1A1A' } as React.CSSProperties,
  sheetDesc: { fontSize: 14, color: '#4A4A4A', fontFamily: "'Caveat', 'Noto Sans Hebrew', cursive" },
  scanOptionBtn: { flexDirection: 'row', alignItems: 'center', gap: 14, paddingVertical: 18, paddingHorizontal: 20, borderRadius: 12, borderWidth: 2, borderColor: '#1A1A1A', backgroundColor: '#FFFACC', boxShadow: '3px 3px 0 #1A1A1A' } as React.CSSProperties,
  ...
  cameraChoiceBox: { borderRadius: 12, borderWidth: 2, borderColor: '#1A1A1A', backgroundColor: '#FFFACC', overflow: 'hidden', boxShadow: '3px 3px 0 #1A1A1A' } as React.CSSProperties,
  ...
  manualOptionBtn: { flexDirection: 'row', alignItems: 'center', gap: 14, paddingVertical: 18, paddingHorizontal: 20, borderRadius: 12, borderWidth: 1.5, borderColor: '#9A9A9A', backgroundColor: '#FFFEF5', boxShadow: '2px 2px 0 #1A1A1A' } as React.CSSProperties,
  ...
  scanningIconBox: { width: 80, height: 80, borderRadius: 12, backgroundColor: '#FFFACC', alignItems: 'center', justifyContent: 'center', marginBottom: 20, overflow: 'hidden', borderWidth: 1.5, borderColor: '#1A1A1A' } as React.CSSProperties,
  ...
  scanningBar: { height: 8, backgroundColor: '#F5F0E0', borderRadius: 8, overflow: 'hidden', width: '100%', borderWidth: 1, borderColor: '#1A1A1A' } as React.CSSProperties,
  scanningBarFill: { height: '100%', backgroundColor: '#00FF66', borderRadius: 8 } as React.CSSProperties,
  scanningPct: { fontSize: 13, color: '#1A1A1A', fontWeight: '700', marginTop: 8, fontFamily: "'Permanent Marker', cursive" },
  resultBox: { backgroundColor: '#E0FFF0', borderRadius: 12, padding: 14, borderWidth: 1.5, borderColor: '#00CC52', flexDirection: 'row', alignItems: 'center', gap: 12, boxShadow: '2px 2px 0 #1A1A1A' } as React.CSSProperties,
  resultIconBox: { width: 56, height: 56, borderRadius: 12, backgroundColor: '#00FF66', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', borderWidth: 1.5, borderColor: '#1A1A1A' } as React.CSSProperties,
  resultPhoto: { width: '100%', height: '100%' },
  resultBadgeRow: { flexDirection: 'row', gap: 6, marginBottom: 2 },
  resultBadge: { backgroundColor: '#E0FFF0', borderRadius: 8, paddingVertical: 1, paddingHorizontal: 7, borderWidth: 1, borderColor: '#00CC52' } as React.CSSProperties,
  ...
  accessoryRow: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: '#FFFEF5', borderRadius: 8, padding: 10, borderWidth: 1, borderColor: '#9A9A9A', boxShadow: '2px 2px 0 #1A1A1A' } as React.CSSProperties,
  accessoryIcon: { width: 28, height: 28, borderRadius: 8, backgroundColor: '#FFFACC', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#1A1A1A' } as React.CSSProperties,
  accessoryText: { fontSize: 14, color: '#1A1A1A', flex: 1, fontFamily: "'Caveat', 'Noto Sans Hebrew', cursive" },
  accessoryAddBtn: { width: 20, height: 20, borderRadius: 8, backgroundColor: '#FFE566', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#1A1A1A' } as React.CSSProperties,
  editDetailsBtn: { flex: 1, padding: 13, borderRadius: 12, borderWidth: 1.5, borderColor: '#9A9A9A', backgroundColor: '#FFFEF5', alignItems: 'center', boxShadow: '2px 2px 0 #1A1A1A' } as React.CSSProperties,
  editDetailsBtnText: { color: '#1A1A1A', fontSize: 15, fontWeight: '700', fontFamily: "'Caveat', 'Noto Sans Hebrew', cursive" },
  addDeviceConfirmBtn: { flex: 2, padding: 13, borderRadius: 12, backgroundColor: '#00FF66', alignItems: 'center', borderWidth: 1.5, borderColor: '#1A1A1A', boxShadow: '3px 3px 0 #1A1A1A' } as React.CSSProperties,
  addDeviceConfirmBtnText: { color: '#1A1A1A', fontSize: 15, fontWeight: '700', fontFamily: "'Caveat', 'Noto Sans Hebrew', cursive" },
  aiDetectedBox: { backgroundColor: '#E0FFF0', borderRadius: 8, padding: 10, flexDirection: 'row', alignItems: 'center', gap: 8, borderWidth: 1, borderColor: '#00CC52' } as React.CSSProperties,
  ...
  formInput: { paddingVertical: 11, paddingHorizontal: 12, borderRadius: 8, borderWidth: 1.5, borderColor: '#9A9A9A', fontSize: 15, backgroundColor: '#FFFEF5', color: '#1A1A1A', fontFamily: "'Caveat', 'Noto Sans Hebrew', cursive" } as React.CSSProperties,
  typeBtn: { paddingVertical: 7, paddingHorizontal: 14, borderRadius: 8, borderWidth: 1.5, borderColor: '#9A9A9A', backgroundColor: '#FFFEF5' } as React.CSSProperties,
  ...
  formSubmitBtn: { padding: 16, borderRadius: 12, backgroundColor: '#00FF66', alignItems: 'center', borderWidth: 1.5, borderColor: '#1A1A1A', boxShadow: '3px 3px 0 #1A1A1A' } as React.CSSProperties,
