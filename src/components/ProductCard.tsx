...
const cardStyles = StyleSheet.create({
  productCard: { width: '48%', backgroundColor: '#FFFEF5', borderRadius: 12, overflow: 'visible', minHeight: 390, borderWidth: 1.5, borderColor: '#1A1A1A', boxShadow: '3px 3px 0 #1A1A1A' } as React.CSSProperties,
  ...
  heartBtn: { position: 'absolute', top: 8, left: 8, width: 32, height: 32, borderRadius: 8, backgroundColor: '#FFFEF5', alignItems: 'center', justifyContent: 'center', borderWidth: 1.5, borderColor: '#1A1A1A', boxShadow: '2px 2px 0 #1A1A1A' } as React.CSSProperties,
  aiBadge: { position: 'absolute', bottom: 8, right: 8, backgroundColor: '#FFE566', borderRadius: 8, paddingVertical: 3, paddingHorizontal: 8, flexDirection: 'row', alignItems: 'center', gap: 4, borderWidth: 1.5, borderColor: '#1A1A1A' } as React.CSSProperties,
  ...
  matchChip: { backgroundColor: '#E0FFF0', borderWidth: 1.5, borderColor: '#00CC52', borderRadius: 8, paddingVertical: 4, paddingHorizontal: 6, marginBottom: 6, alignSelf: 'flex-start' } as React.CSSProperties,
  ...
  sizePill: { backgroundColor: '#FFFEF5', borderRadius: 8, paddingVertical: 2, paddingHorizontal: 5, flexDirection: 'row', alignItems: 'center', gap: 2, borderWidth: 1, borderColor: '#9A9A9A' } as React.CSSProperties,
  ...
  buyBtnAli: { flex: 1, minHeight: 44, backgroundColor: '#00FF66', borderRadius: 12, paddingVertical: 10, paddingHorizontal: 6, alignItems: 'center', justifyContent: 'center', borderWidth: 1.5, borderColor: '#1A1A1A', boxShadow: '3px 3px 0 #1A1A1A' } as React.CSSProperties,
  ...
  toast: { marginTop: 6, backgroundColor: '#1A1A1A', borderRadius: 8, paddingVertical: 5, paddingHorizontal: 10, alignItems: 'center' } as React.CSSProperties,
  toastText: { color: '#FFFEF5', fontSize: 11, fontWeight: '700', fontFamily: "'Caveat', 'Noto Sans Hebrew', cursive" },
  sizeBadge: { position: 'absolute', bottom: 8, left: 8, right: 8, backgroundColor: '#FFE566', borderRadius: 8, paddingVertical: 3, paddingHorizontal: 8, borderWidth: 1.5, borderColor: '#1A1A1A' } as React.CSSProperties,
  ...
  platformBadge: { position: 'absolute', top: 8, right: 8, borderRadius: 8, paddingVertical: 3, paddingHorizontal: 8, borderWidth: 1.5, borderColor: '#1A1A1A' } as React.CSSProperties,
  platformBadgeText: { fontSize: 9, fontWeight: '700', color: '#FFFEF5', fontFamily: "'Permanent Marker', cursive" },
  multiStoreBadge: { position: 'absolute', top: 8, right: 8, backgroundColor: '#00CC52', borderRadius: 8, paddingVertical: 3, paddingHorizontal: 8, borderWidth: 1.5, borderColor: '#1A1A1A' } as React.CSSProperties,
